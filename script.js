    ...
    if(audioElement.paused || audioElement.currentTime<=0){
        ...
        songItems.forEach((element, i)=>{ 
            if(i === songIndex){
                ...
                let ele = element.getElementsByClassName("songItemPlay");
                console.log(ele[0]);
                ele[0].classList.add('fa-pause-circle');
                ele[0].classList.remove('fa-play-circle');
            }
        });
    }
    else{
        ...
        songItems.forEach((element, i)=>{ 
            if(i === songIndex){
                ...
                let ele = element.getElementsByClassName("songItemPlay");
                console.log(ele[0]);
                ele[0].classList.remove('fa-pause-circle');
                ele[0].classList.add('fa-play-circle');
            }
        });
    }
}
...
let songItemsNew = Array.from(document.getElementsByClassName('songName')) 
songItemsNew.forEach((element)=>{
